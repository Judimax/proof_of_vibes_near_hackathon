...
describe('MobileNavComponent', () => {
  let cpnt: MobileNavComponent;
  let fixture: ComponentFixture<MobileNavComponent>;

  beforeEach(async () => {
    await configureTestingModuleForComponents(MobileNavComponent,{mockTranslateService});
    ({fixture, cpnt} =  grabComponentInstance(MobileNavComponent));

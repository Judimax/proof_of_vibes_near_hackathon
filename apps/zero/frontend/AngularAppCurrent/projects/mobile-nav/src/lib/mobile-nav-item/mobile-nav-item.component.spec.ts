...
describe('MobileNavItemComponent', () => {
  let cpnt: MobileNavItemComponent;
  let fixture: ComponentFixture<MobileNavItemComponent>;

  beforeEach(async () => {
    await configureTestingModuleForComponents(MobileNavItemComponent,{mockTranslateService});
    ({fixture, cpnt} =  grabComponentInstance(MobileNavItemComponent));
